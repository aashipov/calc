# Calculator Service: Pure Node.js flavor
...
- `server.ts`: application entry point, HTTP request handler and expression evaluation facility.
...
Release mode: `./build.sh && node server.js`
