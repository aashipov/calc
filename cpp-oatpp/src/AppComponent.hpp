...
#ifndef calc_calc_AppComponent_hpp
#define calc_calc_AppComponent_hpp
...
public:
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::network::virtual_::Interface>,
                         virtualInterface)(Qualifiers::SERVICE_NAME, [this] {
  ...
  OATPP_CREATE_COMPONENT(
      ...
      serverConnectionProvider)(Qualifiers::SERVICE_NAME, [this] {
  ...
  OATPP_CREATE_COMPONENT(
      std::shared_ptr<oatpp::network::ServerConnectionProvider>,
      virtualConnectionProvider)(Qualifiers::SERVICE_VH, [] {
    OATPP_COMPONENT(std::shared_ptr<oatpp::network::virtual_::Interface>,
                    interface, Qualifiers::SERVICE_NAME);
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::web::server::HttpRouter>,
                         httpRouter)(Qualifiers::SERVICE_NAME, [] {
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::data::mapping::ObjectMapper>,
                         apiObjectMapper)(Qualifiers::SERVICE_NAME, [] {
...
#endif // calc_calc_AppComponent_hpp
